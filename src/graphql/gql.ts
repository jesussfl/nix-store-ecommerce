...
const documents = {
    ...
    "\n  query GetStorefrontNews {\n    storefrontNews {\n      id\n      title\n      summary\n      ctaText\n      ctaLink\n      sortOrder\n      isPublished\n      imageAsset {\n        id\n        preview\n        source\n        name\n      }\n    }\n  }\n": types.GetStorefrontNewsDocument,
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "\n  mutation AdjustOrderLine($lineId: ID!, $quantity: Int!) {\n    adjustOrderLine(orderLineId: $lineId, quantity: $quantity) {\n      ...ActiveOrder\n    }\n  }\n"): typeof import('./graphql').AdjustOrderLineDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "\n  query GetStorefrontNews {\n    storefrontNews {\n      id\n      title\n      summary\n      ctaText\n      ctaLink\n      sortOrder\n      isPublished\n      imageAsset {\n        id\n        preview\n        source\n        name\n      }\n    }\n  }\n"): typeof import('./graphql').GetStorefrontNewsDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "\n  mutation AddPaymentToExistingOrder(\n    $orderCode: String!\n    $paymentMethodCode: String!\n    $metadata: JSON\n  ) {\n    addPaymentToExistingOrder(\n      orderCode: $orderCode\n      paymentMethodCode: $paymentMethodCode\n      metadata: $metadata\n    ) {\n      ...ActiveOrder\n      ... on ErrorResult {\n        errorCode\n        message\n      }\n    }\n  }\n"): typeof import('./graphql').AddPaymentToExistingOrderDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "\n  query GetCurrentStockLevel($variantId: ID!) {\n    currentStockLevel(variantId: $variantId)\n  }\n"): typeof import('./graphql').GetCurrentStockLevelDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
